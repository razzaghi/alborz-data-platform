...
class TestCreateAdminCommand(TestCase):
    ...
    def test_raise_error_if_username_is_not_given(self):
        ...
        with self.assertRaises(CommandError):
            command.handle(
                password="whoami", email="example@alborz.com", database="default", interactive=False, verbosity=0
            )
    ...
    def test_raise_error_if_password_is_not_given(self):
        ...
        with self.assertRaises(CommandError):
            command.handle(
                username="user", email="example@alborz.com", database="default", interactive=False, verbosity=0
            )
